...
<body>
    				...
    				<div class="col-md-4">
    					...
    					<div class="pricing1">
    						...
    						<div class="top">
    							...
    							<h2 class="editContent">NamDH3</h2>

    							<p class="price"><b class="editContent">$99</b> <span class="editContent">p/month</span></p>
    						...
    						<div class="bottom">
    							...
    							<div class="editContent">
    							<ul>
    								<li><b>100 GB</b> of space</li>
    								<li><b>unlimited</b> messages</li>
    								<li><b>unlimited</b> user acounts</li>
    								<li><b>100</b> databases</li>
    								<li>unlimited updates</li>
    							</ul>
    							</div><!-- /.editContent -->
    ...
    <script type="text/javascript">
        $(document).ready(function(){
            $.ajax({url: "/siteData", success: function(result){
                console.log('namdh result');
                console.log(result);
            }});
        });
    </script>
